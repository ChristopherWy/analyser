...
import de.analyser.app.domain.Employee;
import de.analyser.app.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link de.analyser.app.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
