...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, de.analyser.app.domain.Blog.class.getName());
            createCache(cm, de.analyser.app.domain.Entry.class.getName());
            createCache(cm, de.analyser.app.domain.Entry.class.getName() + ".tags");
            createCache(cm, de.analyser.app.domain.Tag.class.getName());
            createCache(cm, de.analyser.app.domain.Tag.class.getName() + ".entries");
